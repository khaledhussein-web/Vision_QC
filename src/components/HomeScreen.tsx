...
export default function HomeScreen({ navigate }: HomeScreenProps) {
  const menuItems = [
    { icon: Upload, label: 'Upload Image', screen: 'upload' as Screen, color: 'from-green-500 to-green-600' },
    { icon: History, label: 'My History', screen: 'history' as Screen, color: 'from-blue-500 to-blue-600' },
    { icon: Bookmark, label: 'Bookmarks', screen: 'bookmarks' as Screen, color: 'from-pink-500 to-pink-600' },
    { icon: MessageSquare, label: 'AI Chat', screen: 'chat' as Screen, color: 'from-purple-500 to-purple-600' },
    { icon: Lightbulb, label: 'Solutions', screen: 'history' as Screen, color: 'from-amber-500 to-amber-600' },
    { icon: User, label: 'Profile', screen: 'profile' as Screen, color: 'from-gray-500 to-gray-600' },
  ];
